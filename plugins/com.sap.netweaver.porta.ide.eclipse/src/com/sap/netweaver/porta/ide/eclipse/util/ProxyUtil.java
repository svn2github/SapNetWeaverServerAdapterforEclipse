...
public class ProxyUtil {
	...
	public static void handleProxyException(ProxyException e) {
		...
		IProxyService proxyService = SapNWPlugin.getDefault().getProxyService();
		...
		if (proxyService.isProxiesEnabled()) {
			...
			SapNWPlugin.logError("There are no proxy settings available. Either the host is no more available on the network, or the SAP services are stopped completely on the host. ", null);
		}
	}
